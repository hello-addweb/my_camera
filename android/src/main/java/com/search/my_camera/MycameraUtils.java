...
public class MycameraUtils {
    ...
    /**
     * Camera permission need request if it present in manifest, because for M or great for take
     * Photo or Video by intent need it permission, even if the camera permission is not used.
     *
