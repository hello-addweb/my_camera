 ...
 Widget build(BuildContext context) {
   return Scaffold(
           ...
           Column(
             children: [
               Container(
                 ...
                 child: Row(
                   children: [
                   // Flash light off button. click on the button will off the torch.
                     IconButton(
                       icon: Icon(
                    ...
                    // Flash light on button. click on the button will on the torch.
                     IconButton(
                       icon: Icon(
                         Icons.flash_on,
                         color: Colors.black,
               ...
               // This textfield will show the url of the QR Code and BarCode.
               TextField(
     ...
     floatingActionButton: Column(
         ...
         children: [
         //switch camera button. this is for to switch front and back camera.
